...
public:
	...
	void ApplyDarkThemeColors()
	{
		...
		colors[ImGuiCol_PopupBg] = ImVec4(0.12f, 0.13f, 0.14f, 0.95f);
		colors[ImGuiCol_Border] = ImVec4(0.18f, 0.20f, 0.22f, 0.45f);
		colors[ImGuiCol_BorderShadow] = ImVec4(0, 0, 0, 0);
		...
		// Headers
		colors[ImGuiCol_Header] = ImVec4(0.14f, 0.16f, 0.18f, 0.85f);
		colors[ImGuiCol_HeaderHovered] = ImVec4(0.68f, 0.46f, 0.88f, 0.12f);
		colors[ImGuiCol_HeaderActive] = ImVec4(0.45f, 0.28f, 0.66f, 0.20f);

		// Buttons
		colors[ImGuiCol_Button] = ImVec4(0.14f, 0.16f, 0.18f, 0.80f);
		colors[ImGuiCol_ButtonHovered] = ImVec4(0.68f, 0.46f, 0.88f, 0.14f);
		colors[ImGuiCol_ButtonActive] = ImVec4(0.45f, 0.28f, 0.66f, 0.20f);

		// Frame background
		colors[ImGuiCol_FrameBg] = ImVec4(0.12f, 0.13f, 0.14f, 0.85f);
		colors[ImGuiCol_FrameBgHovered] = ImVec4(0.16f, 0.18f, 0.20f, 0.90f);
		colors[ImGuiCol_FrameBgActive] = ImVec4(0.18f, 0.20f, 0.22f, 0.95f);

		// Tabs
		colors[ImGuiCol_Tab] = ImVec4(0.11f, 0.12f, 0.14f, 0.85f);
		colors[ImGuiCol_TabHovered] = ImVec4(0.58f, 0.36f, 0.78f, 0.20f);
		colors[ImGuiCol_TabActive] = ImVec4(0.58f, 0.36f, 0.78f, 0.28f);
		colors[ImGuiCol_TabUnfocused] = ImVec4(0.10f, 0.11f, 0.12f, 0.80f);
		colors[ImGuiCol_TabUnfocusedActive] = ImVec4(0.14f, 0.15f, 0.16f, 0.85f);

		// Title bar
		colors[ImGuiCol_TitleBg] = ImVec4(0.10f, 0.11f, 0.12f, 1.00f);
		colors[ImGuiCol_TitleBgActive] = ImVec4(0.12f, 0.14f, 0.16f, 1.00f);
		colors[ImGuiCol_TitleBgCollapsed] = ImVec4(0.08f, 0.09f, 0.10f, 0.90f);

		// Scrollbar
		colors[ImGuiCol_ScrollbarBg] = ImVec4(0.07f, 0.07f, 0.08f, 1.00f);
		colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.24f, 0.26f, 0.28f, 0.80f);
		colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.30f, 0.33f, 0.36f, 0.90f);
		colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.34f, 0.37f, 0.40f, 1.00f);

		// Sliders and checks
		colors[ImGuiCol_CheckMark] = ImVec4(0.58f, 0.36f, 0.78f, 1.00f);
		colors[ImGuiCol_SliderGrab] = ImVec4(0.58f, 0.36f, 0.78f, 0.90f);
		colors[ImGuiCol_SliderGrabActive] = ImVec4(0.58f, 0.36f, 0.78f, 1.00f);

		// Resize grip
		colors[ImGuiCol_ResizeGrip] = ImVec4(0.22f, 0.24f, 0.26f, 0.60f);
		colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.30f, 0.32f, 0.34f, 0.75f);
		colors[ImGuiCol_ResizeGripActive] = ImVec4(0.36f, 0.39f, 0.42f, 1.00f);

		// Navigation and selection
		colors[ImGuiCol_NavHighlight] = ImVec4(0.58f, 0.36f, 0.78f, 0.35f);
		colors[ImGuiCol_TextSelectedBg] = ImVec4(0.58f, 0.36f, 0.78f, 0.12f);

		// Menus and popups
		colors[ImGuiCol_MenuBarBg] = ImVec4(0.11f, 0.12f, 0.13f, 1.00f);

		// Overlays
		colors[ImGuiCol_ModalWindowDimBg] = ImVec4(0.06f, 0.06f, 0.07f, 0.60f);
		colors[ImGuiCol_NavWindowingDimBg] = ImVec4(0.05f, 0.05f, 0.06f, 0.55f);
		colors[ImGuiCol_NavWindowingHighlight] = ImVec4(0.58f, 0.36f, 0.78f, 0.60f);

		// DragDrop
		colors[ImGuiCol_DragDropTarget] = ImVec4(0.58f, 0.36f, 0.78f, 0.90f);
	}
};
