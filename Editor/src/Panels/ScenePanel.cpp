...
BoonEditor::ScenePanel::ScenePanel(const std::string& name, EditorContext* pContext, SceneContext* pScene, GameObjectContext* pSelectedGameObject)
	: EditorPanel(name, pContext), m_pSceneContext{pScene}, m_pSelectionContext{pSelectedGameObject}
{
}
